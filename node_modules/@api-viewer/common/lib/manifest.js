...
export const getElementData = (manifest, elements, selected) => {
...
export const getPublicFields = (members = []) => members.filter((x) => x.kind === 'field' && isPublic(x));
export const getPublicMethods = (members = []) => members.filter((x) => x.kind === 'method' && isPublic(x));
