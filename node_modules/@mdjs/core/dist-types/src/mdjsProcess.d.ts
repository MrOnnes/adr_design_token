/// <reference path="../../types/remark.d.ts" />
/**
...
export function mdjsProcess(mdjs: string, { setupUnifiedPlugins }?: {
    ...
    plugins?: import("plugins-manager/dist-types/types/main.js").MetaPlugin<remark2rehype<any[], import("unist").Node<import("unist").Data>, import("unist").Node<import("unist").Data>>>[] | undefined;
}): Promise<{
